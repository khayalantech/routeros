...
add address=testmy.net list=speedtest
add address=whatismyip-address.com list=speedtest
add address=IPSAYA.COM list=speedtest
add address=www.showmyip.com list=speedtest
add address=showmyip.com list=speedtest
add address=showmyipaddress.eu list=speedtest
add address=wwwshowmyipaddress.eu list=speedtest
add address=www.cekipsaya.com list=speedtest
add address=whois.lacnic.net list=speedtest
add address=speedtest.cbn.id list=speedtest
add address=speedsmart.net list=speedtest
add address=ipinfo.io list=speedtest
add address=ipof.me list=speedtest
add address=api.myip.com list=speedtest
add address=fing.com list=speedtest
add address=www.fing.com list=speedtest
